                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Stroke Rehabilitation Rotation & Board Review',
                          style: TextStyle(
                            fontSize: 14,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                ListTile(
                                  ...
                                  title: const Text('Stroke Fundamentals'),
                                  subtitle: Text('${FundamentalsFlashcards.cards.length} cards'),
                                  onTap: () {
                                    Navigator.pop(ctx);
                                    Navigator.push(context, MaterialPageRoute(builder: (_) => FlashcardView(cards: FundamentalsFlashcards.cards, title: 'Stroke Fundamentals Flashcards')));
                                  },
                                ),
                                ListTile(
                                  leading: const Icon(Icons.hub_rounded, color: AppTheme.syndromesColor),
                                  title: const Text('Stroke Syndromes'),
                                  subtitle: Text('${SyndromesFlashcards.cards.length} cards'),
                                  onTap: () {
                                    Navigator.pop(ctx);
                                    Navigator.push(context, MaterialPageRoute(builder: (_) => FlashcardView(cards: SyndromesFlashcards.cards, title: 'Stroke Syndromes Flashcards')));
                                  },
                                ),
                                ListTile(
                                  leading: const Icon(Icons.local_hospital_rounded, color: AppTheme.acuteColor),
                                  title: const Text('Acute Management'),
                                  subtitle: Text('${AcuteMgmtFlashcards.cards.length} cards'),
                                  onTap: () {
                                    Navigator.pop(ctx);
                                    Navigator.push(context, MaterialPageRoute(builder: (_) => FlashcardView(cards: AcuteMgmtFlashcards.cards, title: 'Acute Management Flashcards')));
                                  },
                                ),
                              ],
                            ),
                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text('3 decks', style: TextStyle(fontSize: 11, color: AppTheme.textSecondary)),
                                ],
                              ),
                            ),
                          ],
                    ...
                    child: GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white,
                          borderRadius: BorderRadius.circular(14),
                          border: Border.all(color: AppTheme.vascularColor.withValues(alpha: 0.3)),
                          boxShadow: [
                            BoxShadow(
                        ...
                        child: const Row(
                          children: [
                            Icon(Icons.headset_rounded, color: AppTheme.vascularColor, size: 22),
                            SizedBox(width: 10),
                            Expanded(
                              child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
