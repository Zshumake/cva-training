...
`lib/data/module_contents/stroke_pharmacology_content.dart`
...
3. If podcast.wav is included, copy to `assets/audio/stroke-pharmacology/` and register in the podcast/audio content model
