...
`lib/data/module_contents/ischemic_stroke_content.dart`
...
3. If podcast.wav is included, copy to `assets/audio/ischemic-stroke/` and register in the podcast/audio content model
