# Handoff: cognition-communication
...
| podcast.wav | No | Add to assets/audio/ |
...
`lib/data/module_contents/cognition_communication_content.dart`
...
3. If podcast.wav is included, copy to `assets/audio/cognition-communication/` and register in the podcast/audio content model
